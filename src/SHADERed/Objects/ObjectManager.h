...
namespace ed {
	...
	public:
		...
		bool CreateCubemap(const std::string& name, const std::string& left, const std::string& top, const std::string& front, 
			const std::string& bottom, const std::string& right, const std::string& back, EnvironmentType environmentType = EnvironmentType_None);
		bool CreateCubemap(const std::string& name, const std::string (&paths)[6], EnvironmentType environmentType); //use TextureHelper CubeFace to identify the face
